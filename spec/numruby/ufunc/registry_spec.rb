...
RSpec.describe NumRuby::UFunc::Registry do
  it "has all expected ufuncs registered" do
    expected = [:abs, :add, :arccos, :arcsin, :arctan, :ceil, :cos, :cosh, :div, :exp, :exp2, :floor, :hypot, :log, :log2, :log10, :maximum, :minimum, :mul, :pow, :round, :sign, :sin, :sinh, :sqrt, :sub, :tan, :tanh, :trunc]
